...
const Header = () => {
  ...
  return (
    ...
    <p className="max-w-2xl mx-auto font-Ovo">I am a passionate frontend developer from Bengaluru, India with {yearsOfExperience} years of experience building web applications at companies like Anteriad, Kelly OCG and Element14.</p>
    ...
    <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
        ...
        <a href="/portfolio-dsdm/resume.html?download=true" target="_blank"
